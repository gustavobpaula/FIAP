        //
//  tablaControlar.swift
//  TrabalhoSwift
//
//  Created by hugo duran on 15/8/16.
//  Copyright © 2016 FIAP. All rights reserved.
//

import UIKit

class tablaControlar: UITableViewController {

    @IBOutlet var tabla: UITableView!
    @IBOutlet weak var tabela: UITableViewCell!
    var arraySel = [String]()
    var messageFromLogin = [String]()
    var items: [String] = ["TEste","teste2","teste3"]
